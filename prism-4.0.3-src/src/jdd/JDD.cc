...
JNIEXPORT jint JNICALL Java_jdd_JDD_DD_1ReduceHeap(JNIEnv *env, jclass cls, jint heuristic, jint minsize)
{
	return DD_ReduceHeap(ddman,heuristic,minsize);
}

JNIEXPORT jlong JNICALL Java_jdd_JDD_DD_1threshold(JNIEnv *env, jclass cls, jlong dd)
{
	return ptr_to_jlong( DD_threshold(ddman,jlong_to_DdNode(dd)) ); 
}


JNIEXPORT jlong JNICALL Java_jdd_JDD_DD_1strictThreshold(JNIEnv *env, jclass cls, jlong dd)
{
	return ptr_to_jlong( DD_strictThreshold(ddman,jlong_to_DdNode(dd)) );
}
