...
/*
 * Class:     jdd_JDD
 * Method:    DD_ReduceHeap
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_jdd_JDD_DD_1ReduceHeap
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_jdd_JDD_DD_1threshold
  (JNIEnv *, jclass, jlong);

/*
 * Class:     jdd_JDD
 * Method:    DD_strictThreshold
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_jdd_JDD_DD_1strictThreshold
  (JNIEnv *, jclass, jlong);
