...
public class DebugJDD
{
	...
	/////////////////////////////////////////////////
	//   CI DESSOUS:    PAS NET DU TOUT . . . // plus maintenant
	//   |      |       |       |      |
	//   v      v       v       v      v
        /////////////////////////////////////////////////
	...
	{
		int hc = System.identityHashCode(node);
		int newValue = localCounters.get(hc) + 1; // DU COUP JAI MIS "+1" à la place de "-1" ici
		localCounters.put(hc, newValue);
	}
	/////////////////////////////////////////////////
	//   ^      ^       ^       ^      ^
	//   |      |       |       |      |
	//  NE SENT PAS TRES BON    CI-DESSUS // plus maintenant
        /////////////////////////////////////////////////
	...
	static public void REFCOUNT(JDDNode leNode){
		int hc = System.identityHashCode(leNode);
		int refCount = localCounters.get(hc);
		System.out.print("refCount=" + refCount);
	}
