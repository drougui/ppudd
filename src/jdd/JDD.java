...
public class JDD
{
	...
	private static native int DD_ReduceHeap(int heuristic, int minsize);
	private static native long DD_threshold(long dd);
	private static native long DD_strictThreshold(long dd);
	...
	public static int GetNumNodes(JDDNode dd)                               // GET NUM NODES !!
	{
	...
	public static int ReduceHeap(int heuristic, int minsize)
	{
		return DD_ReduceHeap(heuristic, minsize);
	}
	
	public static JDDNode threshold(JDDNode dd)
	{
		if (DebugJDD.debugEnabled) {
			DebugJDD.decrement(dd);
		}
		return new JDDNode( DD_threshold( dd.ptr() ) );
	}
	
	public static JDDNode strictThreshold(JDDNode dd)
	{
		if (DebugJDD.debugEnabled) {
			DebugJDD.decrement(dd);
		}
		return new JDDNode( DD_strictThreshold( dd.ptr() ) );
	}
}
